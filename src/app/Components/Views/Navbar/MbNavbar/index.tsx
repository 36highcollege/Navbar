...
export default function Mbnav() {
    return (
        <>
            <div className="max-w-7xl flex flex-col items-center justify-center w-full  px-4 rounded-md bg-gradient-to-t to-red-100 via-teal-200 from-sky-100 -z-20">
                {Navbaritem.map((item: any) => (
                    <>
                        <div className="w-full flex  border-b-2 mb-2  border-gray-400 ">
